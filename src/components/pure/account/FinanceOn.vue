<template>
    ...
    <div class="clearfix finance-on">
        ...
        <div class="finance-on-content clearfix">
            <div v-for="item,index in lists" class="on-item clearfix animated zoomIn" :style="{animationDelay:index * 0.1 + 's'}">
...
.scare-buying{
    width: 48px;
    height: 48px;
    background: url(../../../assets/product-center/i-icon.png);
    position: absolute;
    left: 4px;
}
.chief{
