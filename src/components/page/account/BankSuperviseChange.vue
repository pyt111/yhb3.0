<template>
    <div class="clearfix">
      <h4 class="title">修改银行卡</h4>
      <Form class="my-form" ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="120">
            <FormItem label="真实姓名" prop="name">
                <Input size="large" v-model="formValidate.name" placeholder="请填写您的真实姓名" disabled></Input>
            </FormItem>
            <FormItem label="身份证号" prop="idCard">
                <Input size="large" v-model="formValidate.idCard" placeholder="请填写您的身份证号" :maxlength="18" disabled></Input>
            </FormItem>
